  ...
  <modal id="ModalDivision" w="md">
    ...
    <div class="row" slot="modal-body">
      <div class="col-md-10 col-md-offset-1">
        <form id="divisionForm" class="form-horizontal" @keyup.enter="registrar">
...
export default {
  ...
  data () {
    return {
      entries: [
      {label: 'Nombre', id: 'name', icon: 'fa fa-cubes'},
      {label: 'Alias', id: 'slug', icon: 'fa fa-cubes'},
      ],
      msg: {
        name: 'Nombre de la division.',
        slug: 'Alias único de la division.',
      }
    };
  },
  methods: {
    registrar: function () {
      ...
      if (this.formData.cond === 'create') {
        ...
        .then(response => {
          toastr.success('Division Creada');
